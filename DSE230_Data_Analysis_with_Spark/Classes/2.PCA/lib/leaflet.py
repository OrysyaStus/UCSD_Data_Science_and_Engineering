...
class TileLayer(RasterLayer):
    ...
    ##### Change this code to use other maps #######    
    # other maps available: these and many other can be chosen using 
    # https://leaflet-extras.github.io/leaflet-providers/preview/
    #######
    #map_url='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'   #default street map
    #map_att = 'Map data (c) <a href="https://openstreetmap.org">OpenStreetMap</a> contributors'
    map_url='https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png' # topo + roads and towns
    map_att = 'Map data: &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>, <a href="http://viewfinderpanoramas.org">SRTM</a> | Map style: &copy; <a href="https://opentopomap.org">OpenTopoMap</a> (<a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-BY-SA</a>)'
    # map_url ='http://server.arcgisonline.com/ArcGIS/rest/services/World_Shaded_Relief/MapServer/tile/{z}/{y}/{x}.png'
    # map_att = 'Fillin!'
    # map_url ='http://server.arcgisonline.com/ArcGIS/rest/services/World_Physical_Map/MapServer/tile/{z}/{y}/{x}').tag(sync=True)
    # map_att = 'Fillin!'
    ################################################
    
    url=Unicode(map_url).tag(sync=True)
    attribution = Unicode(map_att).tag(sync=True, o=True)
